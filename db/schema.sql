-- =========================================================================
-- Ronny J Ops — Postgres schema (one-time bootstrap)
--
-- This file is the INITIAL schema. Run it ONCE when the Supabase project
-- is first created:
--   1. Create the project in Supabase.
--   2. Paste this file into the SQL editor and run it.
--
-- After that, every schema change lives as a timestamped migration in
--   supabase/migrations/
-- and is applied with:
--   supabase db push
--
-- Do NOT edit this file to add new tables/columns on an existing
-- project — write a migration instead. See supabase/migrations/README.md.
--
-- Conventions:
